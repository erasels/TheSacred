...
import static theSacred.TheSacred.makeCardPath;
import static theSacred.TheSacred.makeUIPath;
    ...
    public static Texture getTexture(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                ...
                return getTexture("theSacredResources/images/ui/missing_texture.png");
            }
        }
