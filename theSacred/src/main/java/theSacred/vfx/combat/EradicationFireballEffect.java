...
import theSacred.vfx.general.RedFireBurstParticleEffect;

public class EradicationFireballEffect extends AbstractGameEffect {
    ...
    public EradicationFireballEffect(float cX, float cY, float distance, float angle, float movementDelay) {
