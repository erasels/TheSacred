...
import theSacred.vfx.general.CalmFireEffect;
import theSacred.vfx.general.CasualFlameParticleEffect;

import java.util.ArrayList;

public class SacredEnergyOrb extends CustomEnergyOrb {
    public static final String[] orbTextures = {
            TheSacred.makeCharPath("orb/layerFake.png"),
            TheSacred.makeCharPath("orb/layerFake.png"),
            TheSacred.makeCharPath("orb/layerFake.png"),
            TheSacred.makeCharPath("orb/layerFake.png"),
            TheSacred.makeCharPath("orb/layerFake.png"),
    ...
    private static final String VFXTexture = TheSacred.makeCharPath("orb/EnergyRecharge.png");
